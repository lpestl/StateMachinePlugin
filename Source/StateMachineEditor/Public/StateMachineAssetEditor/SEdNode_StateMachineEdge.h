...
class STATEMACHINEEDITOR_API SEdNode_StateMachineEdge : public SGraphNode
{
public:
	SLATE_BEGIN_ARGS(SEdNode_StateMachineEdge){}
	SLATE_END_ARGS()

	void Construct(const FArguments &InArgs, UEdNode_StateMachineEdge *InNode);
