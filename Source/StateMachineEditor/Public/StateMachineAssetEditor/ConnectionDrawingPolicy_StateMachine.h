...
class STATEMACHINEEDITOR_API FConnectionDrawingPolicy_StateMachine : public FConnectionDrawingPolicy
{
protected:
	UEdGraph *GraphObj;
...
public:
	FConnectionDrawingPolicy_StateMachine(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor, const FSlateRect &InClippingRect, FSlateWindowElementList &InDrawElements, UEdGraph *InGraphObj);
